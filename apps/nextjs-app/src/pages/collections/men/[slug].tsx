...
function MenCollections() {
  ...
  const getTheCollectionTitle = (route?: string | string[]) => {
    ...
    if (strIncludes("mens-tops"))
      title = "Tops";
    if (strIncludes("drop-cuts"))
      title = "Drop-Cuts";
    if (strIncludes("long-sleeves"))
      title = "Long Sleeves";
    if (strIncludes("vnecks"))
      title = "V-Necks";
    if (strIncludes("crews"))
      title = "Crews";
    if (strIncludes("henleys"))
      title = "Henleys";
    if (strIncludes("polos"))
      title = "Polos";
    if (strIncludes("executive"))
      title = "Executive Collection";
    if (strIncludes("dotted"))
      title = "Dotted Collection";
    if (strIncludes("striped"))
      title = "Stripes";
    if (strIncludes("tanks"))
      title = "Tanks";

    // Men's bottoms collections
    if (strIncludes("mens-bottoms"))
      title = "Bottoms";
    if (strIncludes("shorts"))
      title = "Shorts";
    if (strIncludes("mens-joggers"))
      title = "Joggers";
    if (strIncludes("mens-pants"))
      title = "Pants";

    // Men's outerwear collections
    if (strIncludes("outerwear"))
      title = "Outerwear";
    if (strIncludes("pullovers"))
      title = "Pullovers";
    if (strIncludes("jackets"))
      title = "Jackets";

    // Men's underwear collections
    if (strIncludes("underwear"))
      title = "Underwear";
    if (strIncludes("boxer"))
      title = "Boxer Briefs";
    if (strIncludes("trunks"))
      title = "Trunks";
